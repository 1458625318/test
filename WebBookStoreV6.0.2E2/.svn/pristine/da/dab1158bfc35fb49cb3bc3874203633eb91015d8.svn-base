 ...
 * 静态内容附件
 * @author moshco zhu
 * @开发时间：2016-10-19 14:30:57 901
 */
public class StaticContentAttachment implements Serializable {

	// 数据库表字段:id 描述:记录编号
	protected Integer id = null;

	// 数据库表字段:static_content_id 描述:静态内容表Id
	protected Integer staticContentId = null;
	 ...
	 * @开发时间：2016-10-19 14:30:57 901
	 */
	public void setStaticContentId(Integer staticcontentid) {
