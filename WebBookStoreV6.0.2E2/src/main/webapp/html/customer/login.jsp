...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() 
	%>/css/customer/login/login.css" />
<script type="text/javascript" src="<%=request.getContextPath() 
	%>/js/module/jquery-1.10.2.js"></script>
<script type="text/javascript" src="<%=request.getContextPath() 
	%>/js/module/jquery-ui-1.10.4/jquery-ui-1.10.4.js"></script>
<script type="text/javascript" src="<%=request.getContextPath() 
	%>/js/customer/customer.js"></script>
<script type="text/javascript" src="<%=request.getContextPath() 
	%>/js/customer/login.js"></script>
<title>用户登录 - 万维网上书城</title>
</head>
<body>
<div class="page-head">
...
<div class="page-middle">
	<form name="frmLogin" action="<%=request.getContextPath() 
		%>/customer/login.action" method="post">
		<div class="row">
		...
		<div class="row">
			...
			<span class="readonly">
				<input type="image" title="验证码" src="<%=request.getContextPath() 
					%>/showVerifyCode.action?actionPlace=客户登录&p=<%=System.currentTimeMillis() %>" 
					onclick="return changeVerifyCode($(this));"/>
			</span>
			<span class="readonly">
				<a href="#" onclick="return changeVerifyCode($(this));">看不清，换一张</a>
			</span>
			<span class="clear"></span>
		</div>
		<div class="row">
